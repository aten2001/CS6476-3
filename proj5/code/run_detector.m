...
for i = 1:length(test_scenes)
    ...
    scale_factor = 1;
    max_iterations = 999 * (1-single_scale_on) + 1; % max number of scaling down iterations in case of large images
    ...
    while i_min_dim*scale_factor > ts && iter < max_iterations % smallest dimension must at least be template size
        ...
        for j=1:step_size:ia-cz2+1
            for k=1:step_size:ib-cz2+1
