...
net = proj6_part3_cnn_init();

% if exist(opts.imdbPath, 'file')
%   imdb = load(opts.imdbPath) ;
% else
  imdb = proj6_part3_setup_data(net.normalization.averageImage);
%   mkdir(opts.expDir) ;
...
%64x64x1x50.
%'labels' indicates the ground truth attributes of each image.
